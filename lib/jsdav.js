...
exports.createServer = function(options, port, host, callback) {
    var DAV = require("./DAV/server");
    DAV.debugMode = exports.debugMode;
    return DAV.createServer(options, port, host, callback);
};
 ...
 * [/code]
 */
exports.mount = function(options, callback) {
    var DAV = require("./DAV/server");
    DAV.debugMode = exports.debugMode;
    return DAV.mount(options, callback);
};
...
exports.createServerPlugin = function() {
  var jsDAV_ServerPlugin = require('./DAV/plugin').jsDAV_ServerPlugin;
  console.log("jsDAV_ServerPlugin:\n"+sys.inspect(jsDAV_ServerPlugin));
  return new jsDAV_ServerPlugin();
}
